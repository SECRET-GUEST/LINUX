...
## Tutoriels des distributions linux :


| Nom            | Description                                                  | Lien                                                             | Clone Git                                                            |
|----------------|--------------------------------------------------------------|-------------------------------------------------------------------|----------------------------------------------------------------------|
| Ubuntu         | Tutoriels pour l'installation et la configuration d'Ubuntu, et Linux Debian de manière générale sur une machine standard. | [Voir la branche](https://github.com/SECRET-GUEST/LINUX/tree/Ubuntu) | ```git clone -b Ubuntu https://github.com/SECRET-GUEST/LINUX.git```     |
